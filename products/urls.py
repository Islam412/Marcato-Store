...
from .views import ProductDetails, ProductList, BrandList, BrandDetails, queryset_debug , product_search , product_filter , product_filter_by_tags
...
urlpatterns = [
    ...
    path('filter-by-tags/', product_filter_by_tags, name='product_filter_by_tags'),
